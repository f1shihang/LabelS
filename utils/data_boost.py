...
if __name__ == '__main__':
    label_save_path = r'C:\Users\lengdan\Desktop\taiqiuxiangmu\expend\labels'  # 标签保存路径
    image_save_path = r'C:\Users\lengdan\Desktop\taiqiuxiangmu\expend\images'  # 图片保存路径
    angle_ = -90  # 数据增强采用的图片旋转角度
    path_ = r'C:\Users\lengdan\Desktop\taiqiuxiangmu\XIN'
